...
var CHEMISTRY_DATABASE = {
    ...
    specialReactions: {
        ...
        "CuSO4+NaOH": { full: "CuSO4 + 2NaOH", result: "Cu(OH)2 ↓ + Na2SO4", note: "🔵 راسب أزرق يسود بالتسخين الشديد." },

        // --- كيمياء الحديد (منهج ثانوي) ---
        "Fe+HCl": { full: "Fe + 2HCl", result: "FeCl2 + H2 ↑", note: "تفاعل الحديد مع الأحماض المخففة لإنتاج أملاح حديد II." },
        "Fe+Cl2": { full: "2Fe + 3Cl2", result: "2FeCl3", note: "تفاعل الحديد مع الكلور لإنتاج ملح حديد III (عامل مؤكسد)." },
        "Fe+S": { full: "Fe + S", result: "FeS", note: "اتحاد مباشر: تكوين كبريتيد الحديد II الأسود." },

        // --- الكيمياء العضوية (تبسيط المنهج) ---
        "CH4+O2": { full: "CH4 + 2O2", result: "CO2 + 2H2O", note: "احتراق الميثان (الغاز الطبيعي): ينتج طاقة وبخار ماء." },
        "C2H4+H2": { full: "C2H4 + H2", result: "C2H6", note: "هدرجة الإيثيلين: تحويل غير المشبع إلى إيثان مشبع (صناعة السمن)." },
        "C2H4+Br2": { full: "C2H4 + Br2", result: "C2H4Br2", note: "🔴 اختبار البروم: يزول لون البروم الأحمر (كشف الرابطة المزدوجة)." },
        "CH3COOH+C2H5OH": { full: "CH3COOH + C2H5OH", result: "CH3COOC2H5 + H2O", note: "🍓 تفاعل الأسترة: تكوين إستر برائحة الفواكه المميزة." },
        "C2H5OH+O2": { full: "C2H5OH + 3O2", result: "2CO2 + 3H2O", note: "احتراق الإيثانول: إنتاج ثاني أكسيد الكربون وطاقة." },
        "C2H2+O2": { full: "2C2H2 + 5O2", result: "4CO2 + 2H2O", note: "لهب الأوكسي أسيتيلين المستخدم في لحام المعادن." }
    },

    // 2. قسم الانحلال الحراري (زر تسخين)
    heatLibrary: { 
        "HgO": { full: "2HgO", result: "2Hg + O2 ↑", note: "انحلال أكسيد الزئبق: أحمر ➔ فضي." },
        "Cu(OH)2": { full: "Cu(OH)2", result: "CuO + H2O", note: "انحلال هيدروكسيد النحاس: أزرق ➔ أسود." },
        "CuCO3": { full: "CuCO3", result: "CuO + CO2 ↑", note: "انحلال كربونات النحاس: أخضر ➔ أسود." },
        "CaCO3": { full: "CaCO3", result: "CaO + CO2 ↑", note: "إنتاج الجير الحي من الحجر الجيري." },
        "NH4Cl": { full: "NH4Cl", result: "NH3 + HCl", note: "تسامي كلوريد الأمونيوم (تفاعل انعكاسي بالحرارة)." },
        "Pb(NO3)2": { full: "2Pb(NO3)2", result: "2PbO + 4NO2 + O2", note: "♨️ انحلال نترات الرصاص: تصاعد أبخرة بنية حمراء من NO2." },
        "Fe(OH)3": { full: "2Fe(OH)3", result: "Fe2O3 + 3H2O", note: "انحلال هيدروكسيد الحديد III (عند أعلى من 200°C) لإنتاج الهيماتيت." },
        "FeSO4": { full: "2FeSO4", result: "Fe2O3 + SO2 + SO3", note: "تسخين كبريتات الحديد II لإنتاج أكسيد الحديد III الأحمر." },
        "FeC2O4": { full: "FeC2O4", result: "FeO + CO + CO2", note: "تسخين أكسالات الحديد II بمعزل عن الهواء لإنتاج أكسيد حديد II." },
        "KMnO4": { full: "2KMnO4", result: "K2MnO4 + MnO2 + O2 ↑", note: "طريقة معملية لتحضير الأكسجين بانحلال البرمنجنات." }
    },

    // 3. قسم الأكسدة والاختزال (زر أكسدة/اختزال)
    redoxLibrary: { 
        "CuO+H2": { full: "CuO + H2", result: "Cu + H2O", note: "اختزال أكسيد النحاس: أسود ➔ أحمر (تكوين النحاس)." },
        "CO+Fe2O3": { full: "Fe2O3 + 3CO", result: "2Fe + 3CO2", note: "اختزال الهيماتيت في الفرن العالي (إنتاج الحديد)." },
        "Fe2O3+H2": { full: "Fe2O3 + 3H2", result: "2Fe + 3H2O", note: "اختزال الهيماتيت بالهيدروجين لإنتاج الحديد." },
        "CO2+Mg": { full: "2Mg + CO2", result: "2MgO + C", note: "المغنيسيوم يختزل CO2 ويترك خلفه كربون أسود (فحم)." },
        "C2H5OH+KMnO4": { full: "C2H5OH + [O]", result: "CH3COOH", note: "أكسدة الكحول الإيثيلي إلى حمض الخليك (كشف تعاطي الكحول)." }
    }
};